...
const generator = ({
  company, email, website, minimumAge, updated, dataDownloadUrl,
...
${`
${when(conditions.shop, `Additionally when you make a purchase or attempt to make a purchase through the Site, we collect certain information from you, including your name, billing address, shipping address, payment information (including credit card numbers${when(extras.paymentOptions, `, ${extras.paymentOptions}`)}), email address, and phone number. We refer to this information as “Order Information.”`)}
